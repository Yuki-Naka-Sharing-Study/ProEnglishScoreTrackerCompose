        ...
        Row(
            ...
            SaveButton(
                ...
                errorMessage = when {
                    ...
                    cseMaxScoreError -> "スコアは2551未満である必要があります。"
                    readingMaxScoreError -> "スコアは851未満である必要があります。"
                    listeningMaxScoreError -> "スコアは851未満である必要があります。"
                    writingMaxScoreError -> "スコアは851未満である必要があります。"
