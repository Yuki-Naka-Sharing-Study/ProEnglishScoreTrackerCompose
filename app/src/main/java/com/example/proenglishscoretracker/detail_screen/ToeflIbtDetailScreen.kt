        ...
        Column(
            ...
            if (toeflIbtInfo != null) {
                Row {
                    ...
                    Text(text = toeflIbtInfo!!.date, fontSize = 20.sp)
                }
                Spacer(Modifier.height(16.dp))
                Row {
                    Text(text = "[Overallスコア]", fontSize = 20.sp)
                    Spacer(modifier = Modifier.weight(1f))
                    Text(text = "${toeflIbtInfo!!.overallScore}", fontSize = 20.sp)
                }
                Spacer(Modifier.height(16.dp))
                Row {
                    Text(text = "[Readingスコア]", fontSize = 20.sp)
                    Spacer(modifier = Modifier.weight(1f))
                    Text(text = "${toeflIbtInfo!!.readingScore}", fontSize = 20.sp)
                }
                Spacer(Modifier.height(16.dp))
                Row {
                    Text(text = "[Listeningスコア]", fontSize = 20.sp)
                    Spacer(modifier = Modifier.weight(1f))
                    Text(text = "${toeflIbtInfo!!.listeningScore}", fontSize = 20.sp)
                }
                Spacer(Modifier.height(16.dp))
                Row {
                    Text(text = "[Writingスコア]", fontSize = 20.sp)
                    Spacer(modifier = Modifier.weight(1f))
                    Text(text = "${toeflIbtInfo!!.writingScore}", fontSize = 20.sp)
                }
                Spacer(Modifier.height(16.dp))
                Row {
                    Text(text = "[Speakingスコア]", fontSize = 20.sp)
                    Spacer(modifier = Modifier.weight(1f))
                    Text(text = "${toeflIbtInfo!!.speakingScore}", fontSize = 20.sp)
                }
                Spacer(Modifier.height(16.dp))
                ...
                Row {
                    ...
                    Text(text = toeflIbtInfo!!.memo, fontSize = 20.sp)
                }
            } else {
